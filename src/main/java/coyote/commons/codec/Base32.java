...
public class Base32 extends BaseNCodec {
   ...
   * @param lineSeparator Each line of encoded data will end with this sequence 
   * of bytes.
   * @param useHex if {@code true}, then use Base32 Hex alphabet, otherwise use 
   * Base32 alphabet
   * 
   * @throws IllegalArgumentException The provided lineSeparator included some 
   * Base32 characters. That's not going to work! Or the lineLength &gt; 0 and 
   * lineSeparator is null.
   */
  ...
  void decode( final byte[] in, int inPos, final int inAvail, final Context context ) {
    ...
    // Two forms of EOF as far as Base32 decoder is concerned: actual EOF (-1) 
    // and first time '=' character is encountered in stream. This approach 
    // makes the '=' padding characters completely optional.
